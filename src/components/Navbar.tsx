      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center">
            <OptimizedImage 
              src="/lovable-uploads/uploaded-file.png" 
              alt="Ethical Crop Science Logo" 
              className="h-10 w-auto mr-3"
            />
            <span className="text-xl font-semibold text-primary">Ethical Crop Science</span>
            <span className="ml-2 bg-primary/10 text-primary text-xs px-2 py-0.5 rounded-full">Sustainable</span>
          </Link>
